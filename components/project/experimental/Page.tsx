...
import { Guild, Media, Project, Submission } from '../../../types/payload-types';
...
export function ProjectPage({ project, submissions }: ProjectPageProps) {
	...
	console.log(project.en.devprops);
